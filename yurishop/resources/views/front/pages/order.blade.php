            ...
            <div class="price-box">
                ...
                <div class="col-md-10">
                    ...
                    <input type="text" name="price" value="{{$default_price}}"
                           onkeypress="return restrictCharacters(event, price_characters)">
                    <span class="currency">Tệ</span>
                        @elseif($page=='1688')
                            @foreach ($default_price as $p)
                        <span class="price-range">
                ...
                <div class="col-md-10">
                    ...
                    <div class="size attribute">
                        ...
                        <span class="size-price attr-price">
                            <input type="text" name="price" value="{{ $s['sizePrice'] }}"
                                   onkeypress="return restrictCharacters(event, price_characters)">Tệ
                        </span>
                        ...
                        <div class="amount">
                            ...
                            <input type="text" class="form-control input-number" name="attr_{{ $key }}" value="0" min="0"
                                   onkeypress="return restrictCharacters(event, quantity_characters)">
                ...
                <div class="col-md-10">
                    ...
                    <div class="color attribute">
                        ...
                        <span class="color-price attr-price">
                            <input type="text" name="price" value="{{ $c['colorPrice'] }}"
                                   onkeypress="return restrictCharacters(event, price_characters)">Tệ
                        </span>
...
<script>
    var quantity_characters = /[0-9]/g;
    var price_characters = /[.0-9]/g;
