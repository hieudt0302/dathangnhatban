...
include_once ('app/Libraries/com/alibaba/openapi/sdk/cbusdk/param/AlibabaphotobankphotoAlbumDomain.class.php');

class AlibabaPhotobankAlbumModifyResult {
    ...
    */
    ...
    /**
     * 设置图片相册修改返回结果     
     * @param AlibabaphotobankphotoAlbumDomain $result     
          
     * 此参数必填     */
    public function setResult(AlibabaphotobankphotoAlbumDomain $result) {
        $this->result = $result;
    }
    ...
    */
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->result = new AlibabaphotobankphotoAlbumDomain();
