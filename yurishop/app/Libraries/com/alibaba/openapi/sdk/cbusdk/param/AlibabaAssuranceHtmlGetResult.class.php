...
include_once ('app/Libraries/com/alibaba/openapi/sdk/cbusdk/param/Alibabaassuranceflag.class.php');

class AlibabaAssuranceHtmlGetResult {
    ...
    */
    ...
    /**
     * 设置信保账号标识     
     * @param Alibabaassuranceflag $result     
          
     * 此参数必填     */
    public function setResult(Alibabaassuranceflag $result) {
        $this->result = $result;
    }
    ...
    */
	...
	public function setStdResult($stdResult) {
		$this->stdResult = $stdResult;
    				...
    				$this->result = new Alibabaassuranceflag();
